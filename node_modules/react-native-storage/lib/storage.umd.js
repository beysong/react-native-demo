  ...
  class Storage {
    ...
    _lookupGlobalItem(params) {
      ...
      if (this.enableCache && this.cache[key] !== undefined) {
        return this._loadGlobalItem(babelHelpers.objectSpread({
          ret: this.cache[key]
        }, params));
      }

      return this.getItem(key).then(ret => this._loadGlobalItem(babelHelpers.objectSpread({
        ret
      }, params)));
    }
    ...
    _lookUpInMap(params) {
      ...
      if (this.enableCache && this.cache[newId]) {
        ...
        return this._loadMapItem(babelHelpers.objectSpread({
          ret
        }, params));
      }

      if (m[newId] !== undefined) {
        return this.getItem('map_' + m[newId]).then(ret => this._loadMapItem(babelHelpers.objectSpread({
          ret
        }, params)));
      }

      return this._noItemFound(babelHelpers.objectSpread({
        ret
      }, params));
    }
